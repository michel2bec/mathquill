...
This version is a fork focused on preserving the input LaTeX ( in the original version {} tend to be eaten when they are not "visible" and {{A}^B}^C is merged to A^{BC} ).
