...
LatexCmds.mathbb = bind(Style, '\\mathbb', 'span', 'class="mq-double"');
//text-decoration
...
LatexCmds.widehat = bind(DiacriticAbove, '\\widehat', '&#x0302;', ['widehat(', ')']); // aka circumflex
LatexCmds.tilde = bind(DiacriticAbove, '\\tilde', '&#x0303;', ['tilde(', ')']);
LatexCmds.widetilde = bind(DiacriticAbove, '\\widetilde', '&#x0303;', ['widetilde(', ')']);
